...
/**
 * DetailModalContent - Presentational component for DetailModal
 * Handles all the content display logic without modal shell concerns
 */
const DetailModalContent = ({ item, onClose }) => {
  const {
    getContentById,
    markEpisodeWatched,
  ...
  return (
    <>
      ...
      <div className="p-4 flex-1 overflow-y-auto" style={{
        ...
        {/* Action Buttons */}
        <div className="flex gap-3 pt-4 border-t" style={{borderColor: 'var(--border-color, #2a2a2a)'}}>
          <button
